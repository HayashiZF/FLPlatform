...
class Message(models.Model):
    ...
    def save(self, **kwargs):
        """
        Check message sender and recipient and raise error if they are saved.
...
class ChatRoom(models.Model):
    """
    A private char room
    created_at: datetime value when chatroom is created.
    recipient: user whom the chatroom sends first message.
    sender: user who created the chatroom
    """
    sender = models.ForeignKey(
        AUTH_USER_MODEL, on_delete=models.CASCADE,
